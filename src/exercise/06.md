...
- React is unable to batch setStatus to a single status update when your in an
  asynchronous callback (then callback, .catch callback)
...
- key prop can be used to unmount and re-mount a component
## Background
